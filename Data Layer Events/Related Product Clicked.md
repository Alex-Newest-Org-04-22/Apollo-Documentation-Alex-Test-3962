...
|ecommerce.items[n].recommendation_parent_item_id|string|Captures the unique ID of the parent product or offering for which the related product was shown.|155, 65588, 987764448, cart, none, behavior|||||||
